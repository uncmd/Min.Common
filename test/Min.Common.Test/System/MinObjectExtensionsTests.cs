...
public class MinObjectExtensionsTests
{
    [Fact]
    public void As_Test()
    {
        var obj = (object)new MinObjectExtensionsTests();
        obj.As<MinObjectExtensionsTests>().ShouldNotBe(null);

        obj = null;
        obj.As<MinObjectExtensionsTests>().ShouldBe(null);
    }
